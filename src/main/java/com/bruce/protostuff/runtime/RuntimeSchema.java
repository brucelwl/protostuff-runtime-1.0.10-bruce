...
import static com.bruce.protostuff.runtime.RuntimeEnv.ID_STRATEGY;
...
import com.bruce.protostuff.runtime.RuntimeEnv.DefaultInstantiator;
...
public final class RuntimeSchema<T> extends MappedSchema<T>
{
    ...
    static MapKeyComparator comparator = new MapKeyComparator();
    static void fill(Map<String,java.lang.reflect.Field> fieldMap, Class<?> typeClass)
    {
        ...
        Map<String, java.lang.reflect.Field> sortMap = new TreeMap<String, java.lang.reflect.Field>(comparator);
        ...
        for (Map.Entry<String, java.lang.reflect.Field> entry : sortMap.entrySet()) {
